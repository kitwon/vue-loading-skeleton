...
const _sfc_main$1 = defineComponent({
  ...
  data() {
    return {
      themeStyle: __spreadValues({}, SkeletonStyle)
    };
  },
  render() {
    var _a, _b, _c, _d;
    ...
    if (this.tag) {
      return h(this.tag, (_b = (_a = this.$slots).default) == null ? void 0 : _b.call(_a));
    }
    return (_d = (_c = this.$slots).default) == null ? void 0 : _d.call(_c)[0];
  }
});
var style = "";
...
const _sfc_main = defineComponent({
  ...
  render() {
    const { width, height, duration, prefix, circle, count, tag, isLoading } = this;
    const classes = [`${prefix}-skeleton`];
    const elements = [];
    const styles = __spreadValues({}, this.themeStyle);
    if (duration) {
...
export { _sfc_main as Skeleton, _sfc_main$1 as SkeletonTheme, index as default };
